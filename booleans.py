...
def delete_viewer(uid):
    ...
    try:
        ...
        db.commit()
        #print("viewer deleted")
        return True
    except mysql.connector.Error as e:
        #print("viewer not deleted")
        return False
    finally:
        cursor.close()
        db.close()
...
def list_releases(uid):
    ...
    try:
        ...
        print("error, can't fetch releases:", e)
        return False
    finally:
        cursor.close()
        db.close()
...
def popular_release(N):
    ...
    try:
       ...
       # print("Table - rid, title, reviewCount")
        ...
        print("error, can't fetch popular releases:", e)
        return False
    finally:
        cursor.close()
        db.close()
...
def release_title(sid):
    ...
    try:
        ...
        results = cursor.fetchall()
        if not results:
            print("no release found for this sid")
            return False
        for row in results:
            print(",".join(map(str, row)))
        return True
    except mysql.connector.Error as e:
        print("can't fetch this release title:", e)
        return False
    finally:
        cursor.close()
        db.close()
...
def active_viewers(N, start_date, end_date):
    ...
    try:
        ...
        print("can't fetch active viewers:", e)
        return False
    finally:
        cursor.close()
        db.close()
...
def videos_viewed(rid):
    ...
    try:
        ...
        print("can't fetch videos viewed:", e)
        return False
    finally:
        cursor.close()
        db.close()